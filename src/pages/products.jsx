...
const Products = () => {
	return (
		<>
			<Seo
				title='K-Lord Technologies Products | Scalable Digital Platforms for Healthcare, Business, and Public Sector'
				description="Discover K-Lord Technologies' expanding portfolio of digital products. Built for compliance, performance, and real-world results."
				content=''
			/>
			<HeroComp
