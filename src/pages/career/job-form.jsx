	...
	return (
		<section className='contain grid lg:grid-cols-2 xl:gap-x-20 gap-x-14 gap-y-14 lg:pt-[186px] sm:pt-[120px] pt-20 lg:pb-20 pb-14'>
			<div className='lg:max-w-[480px] w-full'>
				<h1 className='font-sora text-primary lg:text-5xl/[50px] text-[32px]/10 font-semibold tracking-[-2.4px] mb-4'>
					Apply for this position
				</h1>
				<p className='font-inter text-lg/8 font-medium tracking-[-0.18px] text-secondary'>
			...
			<form
				...
				<div className='flex flex-col gap-y-1 w-full'>
					<label htmlFor='reason' className='font-inter text-[#344054] dark:text-[#D0D5DD]'>
						Why do you want to work with us?
					</label>
					<textarea
						id='reason'
						name='reason'
						className='border border-[#EAECF0] text-[#344054] dark:text-[#D0D5DD] rounded-[8px] px-3.5 py-2.5 w-full min-h-[90px] resize-none text-sm/5 font-inter'
