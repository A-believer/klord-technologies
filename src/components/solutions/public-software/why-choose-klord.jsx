	...
	return (
		<section className='contain  py-10 md:space-y-16 space-y-10 font-inter'>
			<div className='max-w-[943px] w-full space-y-4'>
				<h2 className='text-primary font-sora lg:text-5xl/[50px] text-[32px]/10  font-semibold tracking-[-3px]'>
					Seamless Integration & Scalable Architecture
				</h2>
				<p className='text-secondary font-inter text-lg/normal tracking-[-0.18px] max-w-[922px]'>
