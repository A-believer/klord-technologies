...
const Testimonials = ({ testimonials }) => {
	return (
		<section className='contain py-16 md:space-y-16 space-y-10'>
			<h3 className='font-sora text-[#0F0F0F] lg:text-5xl/[50px] text-[32px]/10  font-semibold tracking-[-3px] text-center max-w-[800px] w-full mx-auto'>
				Hear Stories
			...
			<div className='flex flex-wrap gap-x-4 gap-y-6 justify-between '>
				{testimonials.map((testimonial, idx) => (
					<div key={idx} className='xl:w-1/3 sm:w-[48.5%] w-full space-y-5'>
